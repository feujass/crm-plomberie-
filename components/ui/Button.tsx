...
const buttonVariants = tv({
  ...
  variants: {
    variant: {
      ...
      ghost: [
        "shadow-none border-transparent text-gray-900 dark:text-gray-50",
      ...
      danger: [
        ...
        "disabled:bg-red-300 disabled:text-white disabled:dark:bg-red-950 disabled:dark:text-red-400",
      ],
    },
  },
  defaultVariants: {
      ...
      >
        {isLoading ? (
          <span className="pointer-events-none flex shrink-0 items-center justify-center gap-1.5">
            ...
            <span className="sr-only">{loadingText ? loadingText : "Chargement"}</span>
