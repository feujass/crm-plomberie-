...
import { CompteDataRightsClient } from "@/components/compte/CompteDataRightsClient";
...
export default function CompteSecuritePage() {
  return (
    <CompteSubLayout
      title="Sécurité"
      description="Gérez les options de connexion, vos données personnelles et les actions sensibles."
    >
      <div className="space-y-4">
        <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
          <div className="mb-3 flex items-center gap-2">
            <span className="flex size-9 shrink-0 items-center justify-center rounded-full border border-gray-200 bg-gray-50 dark:border-gray-700 dark:bg-gray-800">
              <Database className="size-4 text-gray-700 dark:text-gray-300" aria-hidden />
            </span>
            <div>
              <p className="text-[10px] font-semibold uppercase tracking-wider text-gray-500">RGPD</p>
              <p className="font-semibold text-[var(--foreground)]">Données personnelles</p>
            </div>
          </div>
          <CompteDataRightsClient />
        </div>
        ...
        <div className="rounded-2xl border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-800 dark:bg-gray-900">
          ...
          <p className="mb-3 text-sm text-gray-600 dark:text-gray-400">
            Action sensible — irréversible. Pensez à exporter vos données et factures avant de continuer.
          </p>
          <Link
