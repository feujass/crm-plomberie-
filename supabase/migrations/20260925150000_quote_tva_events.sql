-- App connectée : changement de TVA par ligne et devis multi-taux
...
alter table public.analytics_events add constraint analytics_events_event_type_check check (
  event_type in (
    ...
    'inapp_browser_detected', 'inapp_open_external_click', 'inapp_copy_link_click',
    'onboarding_profile_complete', 'first_devis_created', 'first_devis_sent',
    ...
    'demo_preview_shown', 'demo_confirmation_shown', 'demo_line_edited',
    'demo_transcript_shown', 'demo_line_edited_after_success', 'demo_tva_selected',
    'quote_line_tva_changed', 'quote_multi_tva_used',
    'demo_cta_signup_click', 'demo_rate_limited', 'demo_text_fallback_used'
  )
);
